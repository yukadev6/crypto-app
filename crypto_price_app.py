...
image = Image.open('crypto_logo.jpeg')
...
* **Python Libraries:** streamlit, pandas, base64, matplotlib, BeautifulSoup, requests, json, time
...
# Page layout with 3 columns (col1 = sidebar, col2 and col3 = page contents)
col1 = st.sidebar
...
# Sidebar with cryptocurrency selection
sorted_coin = sorted( df['coin_symbol'] )
selected_coin = col1.multiselect('Cryptocurrency', sorted_coin, sorted_coin)

df_selected_coin = df[ (df['coin_symbol'].isin(selected_coin)) ]

# Sidebar with number of coins selection
...
if percent_timeframe == '7d':
	...
	if sort_values == 'Yes':
		df_change = dg_change.sort_values(by=['percent_change_24h'])
